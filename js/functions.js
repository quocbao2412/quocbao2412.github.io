...
function pullRightAction () {
        ...
        var newLi = $('<li>').append($('<img/>', { src:'images/522-1.png' }))
            .append($('<img/>', { src:'images/429-1.png' }))
            .append($('<img/>', { src:'images/388-1.png' }));
        ...
        trimStart -= rulerLength;
        var qStr = '?trimStart='+trimStart+'&rulerLength='+rulerLength;
        var newLi = $('<li>').append($('<img/>', { src:'images/522-2.png' }))
            .append($('<img/>', { src:'images/429-2.png' }))
            .append($('<img/>', { src:'images/388-2.png' }));
        ...
        trimStart -= rulerLength;
        var qStr = '?trimStart='+trimStart+'&rulerLength='+rulerLength;
        var newLi = $('<li>').append($('<img/>', { src:'images/522-3.png' }))
            .append($('<img/>', { src:'images/429-3.png' }))
            .append($('<img/>', { src:'images/388-3.png' }));
        ...
        var qStr = '?trimStart='+trimStart+'&rulerLength='+rulerLength;
        var newLi = $('<li>').append($('<img/>', { src:'images/522-4.png' }))
            .append($('<img/>', { src:'images/429-4.png' }))
            .append($('<img/>', { src:'images/388-4.png' }));
